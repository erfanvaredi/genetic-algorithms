...
df_results = df_results.append(pd.Series([count_of_accepted_customer_loan_type_m / count_of_accepted_customer,
                                          ...
                                          generation_size], index=df_results.columns), ignore_index=True)
